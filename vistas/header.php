		            ...
		            <div class="collapse navbar-collapse navbar-responsive-collapse">
		                <div class="res-container">
		                    <ul class="nav navbar-nav" id="page-header-main-navbar">
		                        <li class="dropdown home active"><a href="/" class="dropdown-toggle">Inicio</a></li>
		                        <li class="dropdown">
		                            <a href="internet" class="dropdown-toggle" aria-expanded="false">Internet</a>
		                        ...
		                        <li class="dropdown" style="display:none;">
		                            ...
		                            <ul class="dropdown-menu pn">
		                                <li class="br-b"><a href="#">PAQUETES HYBTEL</a></li>
		                        ...
		                        <li class="dropdown mega-menu-fullwidth"><a href="ventajas" class="dropdown-toggle">Ventajas</a></li>
		                        <li><a href="contacto" class="prn">Contacto</a></li>
